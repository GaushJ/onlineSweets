        ...
        <div className=" bg-white transition duration-300 ease-in-out m-2 md:h-96 lg:h-96 md:w-72 lg:w-72 rounded-lg hover:shadow-lg drop-shadow-md border-2  overflow-hidden flex md:flex-col lg:flex-col sm:flex-row sm:w-full">
            ...
            <div className="p-2 text-grey-darker text-justify flex flex-col border-t align-bottom">
                <p className="uppercase  mx-6 text-sm hover:text-blue-dark duration-4 self-center">
                    lorem ipsum this is some paragraph about something which is fetched from the data 
                </p>
                <button className="uppercase  bg-red-500  hover:bg-green-500 transition duration-300 font-medium text-white px-2 py-2 rounded  ">Add to cart</button>
            </div>
